...
#define              MT9P031_PLL_CONFIG_1_M_96MHZ    0x1800
#define              MT9P031_PLL_CONFIG_1_N_96MHZ    0x0001
...
static int mt9p031_init_camera(const struct i2c_client *client)
{
	...
	ret |= mt9p031_reg_write(client, REG_MT9P031_PLL_CTRL, MT9P031_PLL_CONTROL_PWRON | MT9P031_PLL_CONTROL_USEPLL);		//PLL_CONTROL; use PLL
	mdelay(200);
